        ...
        <Card className="shadow-lg border border-border rounded-2xl">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <User className="w-5 h-5 text-primary" /> Inte Name
            </CardTitle>
        ...
        <Card className="md:col-span-2 shadow-xl border border-border rounded-2xl bg-gradient-to-r from-green-100 to-green-50 dark:from-green-900 dark:to-green-800">
          ...
          <CardContent>
            <p className="text-3xl font-bold text-green-700 dark:text-green-400">
              ₹{user?.amountRaised?.toLocaleString()|| totalDonations.toLocaleString()}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="shadow-lg border border-border rounded-2xl">
        ...
        <CardContent className=" space-y-3 text-muted-foreground text-base">
          <ul className="list-disc list-inside space-y-1">
            <li>
               <strong>Bronze Badge</strong> – Raised ₹1000+
            </li>
            <li>
               <strong>Total Money</strong> – Raised ₹5000+
            </li>
            <li>
               <strong>Leaderboard Access</strong> – Coming Soon
            </li>
          </ul>
        </CardContent>
      </Card>
